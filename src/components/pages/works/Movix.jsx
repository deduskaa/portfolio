  ...
  <Wrapper>
    ...
    <Section>
      <Column>
        ...
        <Text>
          Movix is an app I made for fun, trying to copy a UI I found from dribbble with a small
          twist. I also added search and save functionalities.
        </Text>
      </Column>
      <Column>
    ...
    <Section>
      <Text>
        Users favourites are saved in local storage, while popular and top rated movies are saved in
        cache.
      </Text>
    </Section>
    <Heading>
